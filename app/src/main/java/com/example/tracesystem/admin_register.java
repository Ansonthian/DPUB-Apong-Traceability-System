                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            FirebaseDatabase.getInstance().getReference("Admin")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(admin_register.this, "Registration Sucess", Toast.LENGTH_LONG).show();
                                        startActivity(new Intent(admin_register.this, sapharvester_menu.class));
                                    } else {
                                    }
                                }
                            });
                            ...
                            progressBar.setVisibility(View.GONE);
                            Toast.makeText(admin_register.this, "Registration Failed", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
