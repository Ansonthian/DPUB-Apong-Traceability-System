...
public class Sapharvester_register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sapharvester_register);
        ...
        mLoginBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), sapharvester_login.class));
            }
        });
    }
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            FirebaseDatabase.getInstance().getReference("Sap Harvester")
                                    .child(resultemail)
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(Sapharvester_register.this, "Registration Sucess", Toast.LENGTH_LONG).show();
                                        startActivity(new Intent(Sapharvester_register.this, sapharvester_menu.class));
                                    } else {
                                    }
                                }
                        });
                            ...
                            progressBar.setVisibility(View.GONE);
                            Toast.makeText(Sapharvester_register.this, "Registration Failed", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
